import { OriginalTeam, ExpectedTeam, SomeArray, originalTeamToExpectedTeam, originalArrayToExpectedArray, originalTeamToExpectedTeam2 } from './immutability';
...
// Задание 2
test('array to array', () => {
    const originalArray: SomeArray = Object.freeze([1, 2, 3, 4]);
